...
import org.firstinspires.ftc.teamcode.pedroPathing_old.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    public static String leftRearMotorName = "lbm";
    public static String rightFrontMotorName = "rfm";
    public static String rightRearMotorName = "rbm";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 61.7536;
    private static double yMovement = 43.9856;
    ...
    public static double mass = 13.548;
    ...
    public static double forwardZeroPowerAcceleration = -28.9039;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -78.2881;
