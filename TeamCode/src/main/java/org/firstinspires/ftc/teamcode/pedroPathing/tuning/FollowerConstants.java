...
public class FollowerConstants {
    ...
    private static double xMovement = 55.84055983175443;
    private static double yMovement = 39.400716466227856;
    ...
    public static double mass = 14.786;
    ...
    public static double forwardZeroPowerAcceleration = 29.745921596362486;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -73.7886080226688;
