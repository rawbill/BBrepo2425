...
@Config
@Autonomous(name = "5+0 RR", group = "Auto")
public class Spec5RR extends LinearOpMode {
    ...
    Action place1, pushesAndPick2, place2, pick3, place3, pick4, place4, pick5, place5, park;
...
//                .setTangent(Math.toRadians(90))
        ...
        pick5 = pick5Path.build();
        place5 = place5Path.build();
        park   = parkPath.build();
