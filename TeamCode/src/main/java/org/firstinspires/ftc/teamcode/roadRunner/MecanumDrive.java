...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 24.0 / 8148;
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 3730.472042421687;

        // feedforward parameters (in tick units)
        public double kS = 0.9523055970195338;
        public double kV = 0.0004315645247851117;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        //   see https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/index.html
        lazyImu = new LazyHardwareMapImu(hardwareMap, "extImu", new RevHubOrientationOnRobot(
                PARAMS.logoFacingDirection, PARAMS.usbFacingDirection));

        voltageSensor = hardwareMap.voltageSensor.iterator().next();

        localizer = new DoubleLocalizer(hardwareMap, lazyImu.get(), PARAMS.inPerTick, pose);
