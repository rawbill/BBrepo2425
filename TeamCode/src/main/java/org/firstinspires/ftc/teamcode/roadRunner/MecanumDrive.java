...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.6880873573618725; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 9.811760893867513;

        // feedforward parameters (in tick units)
        public double kS = 0.9594210820863189;
        public double kV = 0.1603630464082653;
